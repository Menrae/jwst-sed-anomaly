...
of CEERS galaxies are genuinely anomalous; the 2\% figure describes only
...
(i.e., we assume any source whose SED genuinely reflected non-standard
physics would certainly present as flagged and unexplained). For
...
mismatch, rather than genuine anomalies, drives a meaningful share of the
